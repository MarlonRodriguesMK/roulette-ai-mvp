...
// Mapa físico igual ao seu backend (roulette_map.py)
const WHEEL = [
      ...
      >
        ...
        <div className="modal-body">
                ...
                {physicalNeighbors.length ? (
                  <>
                    ...
                    <div className="muted" style={{ marginTop: 8, fontSize: 12 }}>
                      Pressão vem do backend em <code>neighbors</code> (contador de vizinhança).
                    </div>
                  </>
                ) : (
                  ...
                  <>
                    <div style={{ display: "flex", justifyContent: "space-between", gap: 10 }}>
                      <strong>
                        ...
                        <span style={{ color: zoneInfo.zone.status?.includes("Quente") ? "var(--gold)" : zoneInfo.zone.status?.includes("Fria") ? "var(--green)" : "var(--text)" }}>
                    ...
                    {zoneInfo.zone.explanation ? (
                      <div className="muted" style={{ marginTop: 8, fontSize: 12 }}>{zoneInfo.zone.explanation}</div>
                    ) : null}
                  </>
                ) : (
          ...
          <div style={{ marginTop: 12 }} className="muted">
            Dica: clique em qualquer bolinha da timeline para abrir esse modal e ver tudo do giro.
          </div>
        </div>
      </motion.div>
    </div>
